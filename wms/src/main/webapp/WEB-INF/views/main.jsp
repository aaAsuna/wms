		 ...
		 <div id="left_menu_cnt">
		 	...
		 	<div id="nav_resource">
		 		<ul id="dleft_tab1" class="ztree">
					<li>
						<a href="/employee/query.do" target="right">员工管理</a>
					</li>
					<li>
						<a href="/department/query.do" target="right">部门管理</a>
					</li>
					<li>
						<a href="/role/query.do" target="right">角色管理</a>
					</li>
					<li>
						<a href="/permission/query.do" target="right">权限管理</a>
					</li>
		 		</ul>
		 	</div>
		 </div>
