...
<body>
<form action="/supplier/saveOrUpdate.do" method="post" id="editForm">
		...
		<div class="ui_content">
			<table cellspacing="0" cellpadding="0" width="100%" align="left" border="0">
				<tr>
					...
					<td class="ui_text_lt">
						<input type="text" name="name" value="${supplier.name}" class="ui_input_txt02"/>
					</td>
				</tr>
				<tr>
					<td class="ui_text_rt" width="140">供应商代码</td>
					<td class="ui_text_lt">
						<input type="text" name="sn" value="${supplier.sn}" class="ui_input_txt02"/>
					</td>
				</tr>
				<tr>
					<td>&nbsp;</td>
